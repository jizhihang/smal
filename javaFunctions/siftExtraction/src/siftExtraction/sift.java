...
/**
 * The <code>sift</code> class provides a Java interface to the M-functions
 * from the files:
 * <pre>
 *  D:\\lena\\Codes\\MyCodes\\LaplacianEigenmaps_Code\\matlab\\SIFTFeatureExtraction\\featureExtractionFunc.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>sift</code> instance when 
 * it is no longer needed to ensure that native resources allocated by this class are 
 * properly freed.
 * @version 0.0
 */
public class sift extends MWComponentInstance<sift>
{
    /**
     ...
     */
    private sift (final MWMCR mcr) throws MWException
    {
        super(mcr);
    ...
    /**
     * Constructs a new instance of the <code>sift</code> class.
     */
    public sift() throws MWException
    {
        this(SiftExtractionMCRFactory.newInstance());
    }
    ...
    /**
     * @deprecated Please use the constructor {@link #sift(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     */
    public sift(String pathToComponent) throws MWException
    {
        this(SiftExtractionMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>sift</code> class. Use this constructor to 
     ...
     */
    public sift(MWComponentOptions componentOptions) throws MWException
    {
        this(SiftExtractionMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = SiftExtractionMCRFactory.newInstance();
    ...
    /**
     * Provides the interface for calling the <code>featureExtractionFunc</code> M-function 
